...
if __name__ == '__main__':
    ...
    if opts.r == 'one':
        ...
        plt.plot(fpr, tpr, 'r-', lw=2, alpha=0.8, color='blue', label='XGBDTI:AUROC=%.3f' % auc)
        plt.plot(recall, precision, 'r-', lw=2, alpha=0.8, color='green', label='XGBDTI:AUPR=%.3f' % aupr)
