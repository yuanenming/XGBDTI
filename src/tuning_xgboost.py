...
def grid_search_tuning(X,y,hyperparameter_grids,booster,
    ...
    hyperparameter_grid : list of dictionaries - [{Grid_Dictionary_1}, {Grid_Dictionary_2}, ...]
        ...
        e.g.: hyperparameter_grid = [{'learning_rate': [0.1, 0.2, 0.3], 'n_estimators': [50, 75, 100]},{'max_depth': [3, 4],\
         'min_child_weight': [1, 2]}, {'colsample_bylevel': [0.7, 0.8, 0.9], 'subsample': [0.5, 0.6, 0.7]},{'scale_pos_weight': [1, 2, 3, 4]}]
